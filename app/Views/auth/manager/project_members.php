...
<div class="mb-5">
    <div class="row mb-4">
        <div class="col-md-12">
            ...
            <p class="text-muted mt-2">Asigna miembros y define encargados para tus proyectos.</p>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="/manager/project-members/assign" id="assignForm">
                <div class="row g-3">
                    <div class="col-lg-12">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Mis Proyectos y Gestión de Miembros</h5>
        </div>
        <div class="card-body">
                ...
                <?php foreach ($proyectos as $p): ?>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                            // Get the db connection - passed from controller
                            $stmt = $db->prepare(
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <div class="d-flex gap-2 mt-3">
                                                    <?php if ($m['role_in_project'] === 'member'): ?>
                                                        <form method="post" action="/manager/project-members/promote/<?= $m['id'] ?>" class="flex-fill">
                                                            <button type="submit" class="btn btn-sm btn-outline-warning w-100" title="Promover a Encargado">
                                                                Promover
                                                            </button>
                                                        </form>
                                                    <?php else: ?>
                                                        <form method="post" action="/manager/project-members/demote/<?= $m['id'] ?>" class="flex-fill">
                                                    ...
                                                    <form method="post" action="/manager/project-members/unassign/<?= $m['id'] ?>" class="flex-fill"
